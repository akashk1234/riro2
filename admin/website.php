          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-sm-6 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h5 style="color: #00d25b;">Edit </i></h5>
                    <a href="slider.php" style="color: white; text-decoration: none;">
                      <div class="row">
                          <div class="col-8 col-sm-12 col-xl-8 my-auto">
                            <div class="d-flex d-sm-block d-md-flex align-items-center">
                              <h2 class="mb-0">Slider <i class="fa-regular fa-pen-to-square"></i></h2>
                            </div>
                          </div>
              ...
              <div class="col-sm-6 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h5 style="color: #00d25b;">Edit </i></h5>
                    <a href="featured.php" style="color: white; text-decoration: none;">
                      <div class="row">
                          <div class="col-8 col-sm-12 col-xl-8 my-auto">
                            <div class="d-flex d-sm-block d-md-flex align-items-center">
                              <h2 class="mb-0">Featured <i class="fa-regular fa-pen-to-square"></i></h2>
                            </div>
                          </div>
                        <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                          <i class="icon-lg mdi mdi-star-circle text-info ml-auto"></i>
                        </div>
                      </div>
                    </a>
                  </div>
              ...
              <div class="col-sm-6 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h5 style="color: #00d25b;">Edit</h5>
                    <a href="privacy-policy.php" style="color: white; text-decoration: none;">
                      <div class="row">
                        <div class="col-8 col-sm-12 col-xl-8 my-auto">
                          <div class="d-flex d-sm-block d-md-flex align-items-center">
                            <h2 class="mb-0">Privacy Policy <i class="fa-regular fa-pen-to-square"></i></h2>
                          </div>
                        </div>
                        <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                          <i class="icon-lg mdi mdi-clipboard-check text-warning ml-auto"></i>
                        </div>
                      </div>
                    </a>
                  </div>
              ...
              <div class="col-sm-6 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h5 style="color: #00d25b;">Edit</h5>
                    <a href="refund-policy.php" style="color: white; text-decoration: none;">
                      <div class="row">
                        <div class="col-8 col-sm-12 col-xl-8 my-auto">
                          <div class="d-flex d-sm-block d-md-flex align-items-center">
                            <h2 class="mb-0">Refund Policy <i class="fa-regular fa-pen-to-square"></i></h2>
                          </div>
                        </div>
                        <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                          <i class="icon-lg mdi mdi-credit-card-multiple
                          text-danger ml-auto"></i>
                        </div>
                      </div>
                    </a>
                  </div>
              ...
              <div class="col-sm-6 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h5 style="color: #00d25b;">Edit</h5>
                    <a href="terms-of-use.php" style="color: white; text-decoration: none;">
                      <div class="row">
                        <div class="col-8 col-sm-12 col-xl-8 my-auto">
                          <div class="d-flex d-sm-block d-md-flex align-items-center">
                            <h2 class="mb-0">Terms of Use <i class="fa-regular fa-pen-to-square"></i></h2>
                          </div>
                        </div>
                        <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
