          ...
          <div class="content-wrapper">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-12 col-sm-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <a href="new-orders.php" style="color: white; text-decoration: none;">
                              <div class="row">
                                  <div class="col-9">
              ...
              <div class="col-xl-12 col-sm-12 grid-margin stretch-card">
                  <div class="card">
                      <div class="card-body">
                          <a href="shipped-orders.php" style="color: white; text-decoration: none;">
                            <div class="row">
                                <div class="col-9">
                                    <div class="d-flex align-items-center align-self-start">
              ...
              <div class="col-xl-12 col-sm-12 grid-margin stretch-card">
                  <div class="card">
                      <div class="card-body">
                          <a href="delivered-orders.php" style="color: white; text-decoration: none;">
                            <div class="row">
                                <div class="col-9">
                                    <div class="d-flex align-items-center align-self-start">
                                        <h3 class="mb-0">Delivered Orders</h3>
                                        <p class="text-success ml-2 mb-0 font-weight-medium">(288)</p>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="icon icon-box-success">
