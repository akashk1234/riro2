...
if (isset($_GET['id'])) {
    $orderId = $_GET['id'];
    $q = "UPDATE user_address SET status = 'Delivered' WHERE user_address_id = '$orderId'";
    update($q);
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                        <?php
                        $q = "select * from user_address where status='Shipped'";
                        $res = select($q);
                        $i = 1;
                        foreach ($res as $row) {
                          ?>
                          ...
                          <td><?php echo $i++ ?></td>
                            ...
                            <td><button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#detailsModal">Details</button>
                                <button type="button" class="btn btn-outline-success"><a href="?id=<?php echo $row['user_address_id']?>">Deliver</a></button></td>
