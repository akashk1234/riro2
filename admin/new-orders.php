...
if (isset($_GET['id'])) {
    $orderId = $_GET['id'];
    $q = "UPDATE user_address SET status = 'Shipped' WHERE user_address_id = '$orderId'";
    update($q);
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                        <?php
                        $q = "select * from user_address where status='waiting'";
                        $res = select($q);
                        $i = 1;
                        foreach ($res as $row) {
                          ?>
                          <tr>
                            ...
                            <td>
                              <div class="badge badge-outline-warning"><?php echo  $row['status']; ?></div>
                            </td>
                            <td><button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#detailsModal">Details</button>
                                <button type="button" name="ship" class="btn btn-outline-success"><a href="?id=<?php echo $row['user_address_id']?>">Ship</a></button></td>
                          </tr>
                          <?php } ?>
                        </tbody>
                      </table>
