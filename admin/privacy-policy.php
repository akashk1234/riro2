...
if (isset($_POST["privacy"])) {
  ...
  $q = "UPDATE privacy SET description='$description'";
  update($q);
  echo '<script>alert("Privacy policy updated successfully.");</script>';
}
?>
<!DOCTYPE html>
<html lang="en">
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post">
                      ...
                      <div class="form-group">
                        <label for="exampleTextarea1" style="color: gray;">Edit privacy policy</label>
                        <!-- Modify the textarea to display the privacy policy description -->
                        <?php
        $row = "SELECT * FROM privacy";
       $res=select($row);
        
    ?>
    <textarea class="form-control" name="description" id="exampleTextarea1" value="<?php echo $res[0]['description']; ?>" rows="4"></textarea></div>
                      <button type="submit" name="privacy"  class="btn btn-primary mr-2">Update</button>
