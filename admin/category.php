...
if (isset($_POST['save'])) {
  extract($_POST);
  $dir = "assets/admin/category/";
  $file = basename($_FILES['catimage']['name']);
  $file_type = strtolower(pathinfo($file, PATHINFO_EXTENSION));
  $target = $dir . uniqid("images_") . "." . $file_type;

  if (move_uploaded_file($_FILES['catimage']['tmp_name'], $target)) {
    $q = "INSERT INTO category (cat_name, cat_image) VALUES ('$catname', '$target')";
    insert($q);
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <a class="nav-link btn btn-success create-new-button mb-5 mt-5" data-toggle="modal"
                    data-target="#addCategory " aria-expanded="false" href="#">+ Add New Category</a>
                      ...
                      <?php
                        ...
                        foreach ($res as $row) {
                          ...
                          <tr>
                            ...
                            <td class="py-1">
                              <img style="border-radius: 0px;" src="<?php echo $row['cat_image'] ?>" alt="image" />
                            </td>
                            <td>
                            ...
                            <td><button type="button" class="btn btn-outline-danger"><a
                                  href="?did=<?php echo $row['cat_id'] ?>" style="color: inherit;"
              ...
              <div class="modal-content">
                ...
                <form method="POST" enctype="multipart/form-data">
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      <label for="field1">Category image</label>
                      <input type="file" name="catimage" class="form-control text-white" id="field1">
                    </div>
                    <div class="form-group">
                      <label for="field2">Category name</label>
                      <input type="text" name="catname" class="form-control text-white" id="field2"
