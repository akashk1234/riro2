	...
	<div class="bg0 m-t-63 p-b-50">
		...
		<div class="container">
			...
			<div class="row isotope-grid">
				<?php
				$q = "select * from product inner join category using(cat_id) where cat_name='Dhotis'";
				$res = select($q);
				...
				foreach ($res as $row) {
					...
					<div style="width: 50%;"
						class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 p-b-35 isotope-item <?php echo $row['cat_name'] ?>">
						<!-- Block2 -->
						<div class="block2">
	...
	<div class="sec-banner bg0 p-b-55">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-6 col-lg-4 col-sm-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
